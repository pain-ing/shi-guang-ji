...
export type MediaFileCreate = Omit<MediaFile, 'id' | 'created_at' | 'updated_at'>
export type MediaFileUpdate = Partial<Omit<MediaFile, 'id' | 'user_id' | 'created_at' | 'updated_at'>>
